        ...
        <div class="d-table-cell">
            <div class="container">
                <div class="text-center mt-45px">
                    <h2 class="max-md:text-35px md:text-42px mb-0 text-[#ffffff] font-700 uppercase">Giải pháp</h2>
                    <ul class="font-[quicksand] pl-0 list-none mt-12px mb-0">
                        ...
                        <li class="text-[#ffffff] inline-block relative font-400 text-17px ml-10px mr-10px">Giải pháp</li>
                    </ul>
                </div>
            </div>
        </div>
